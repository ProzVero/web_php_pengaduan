...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Data Tabel Pelaku</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $nk=$_GET['nk'];
                                    $query=mysqli_query($konek, "select * from pelaku");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $d['nk']; ?></td>
                                            <td><img src="asset/img/pelaku/<?php echo $d['gambar'] ?>" style="width: 75px; height: 75px"></td>
                                            <td> 
                                                <a Onclick="return confirm('Yakin Mau Hapus?...');"href="hapus_pelaku.php?npl=<?php echo $d['npl']; ?>">
