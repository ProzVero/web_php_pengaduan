...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Data Tabel Aduan</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr class="info">
                                            ...
                                            <th>Uraian Tentang Pengaduan Online Masyarakat</th>
                                            <th>Np</th>
                                            <th>Gambar</th>
                                            <th>Action</th>
                                        </tr>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $d['tkp']; ?></td>
                                            <td><?php echo $d['isi']; ?></td>
                                            <td><?php echo $d['np']; ?></td>
                                            <td><img src="asset/img/aduan/<?php echo $d['gambar'] ?>" style="width: 75px; height: 75px"></td>
                                            <td><!-- <a href="edit_aduan.php?kode=<?php echo $d['kode'];?>">
                                                    <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                                </a> -->
                                                <a href="detail_aduan.php?kode=<?php echo $d['kode']; ?>">
                                                    <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                                                </a>
                                                <a Onclick="return confirm('Yakin Mau Hapus?...');"href="hapus_aduan.php?kode=<?php echo $d['kode']; ?>">
