...
<body>
    <?php
        ...
        $query1 = mysqli_query($konek, "SELECT * FROM himbauan WHERE no = '$no'");
    ?>
    <div id="wrapper">
        ...
        <div class="panel panel-info col-md-12">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover table-bordered">
                    <tr class="info">
                        <td colspan="2"><h5><p align="center"><b>FORM EDIT HIMBAUAN</b></p></h5></td>
                    </tr>
                    <tr>
                        <td>Judul</td>
                        <td><input class="form-control" type="text" name="judul" value="<?php echo $h['judul']; ?>" placeholder="Username..." maxlength="30" size="70px"></td>
                    </tr>
                    <tr>
                        <td>Keterangan</td>
                        <td><textarea class="" name="ket" rows="5" cols="50" ><?php echo $h['ket']; ?></textarea></td>
                    </tr>
                    <tr>
                ...
                <td colspan="2" align="center">
                  ...
                  {
                  $query1="UPDATE himbauan SET judul = '$judul', ket = '$ket' WHERE no = '$no' ";
