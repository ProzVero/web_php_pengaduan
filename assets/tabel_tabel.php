...
<body>
    <?php
        ...
        $query = mysql__query("SELECT * FROM admin WHERE adminname = '$adminname'");
        $hasil = mysql__fetch_array($query);
    ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Data Relasi Tabel</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $nk=$_GET['nk'];
                                    $query=mysql__query("select * from korban");
                                    while($d=mysql__fetch_array($query))
                                        {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> 
                                                <a Onclick="return confirm('Yakin Mau Hapus?...');"href="hapuspengaduan.php?no=<?php echo $d['kode']; ?>">
