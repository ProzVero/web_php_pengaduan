...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Data Tabel Kejahatan Polsek</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $d['modus']; ?></td>
                                            <td><?php echo $d['datetime']; ?></td>
                                            <td>  
                                                <a Onclick="return confirm('Yakin Mau Hapus?...');"href="hapus_kejahatan.php?no=<?php echo $d['no']; ?>">
